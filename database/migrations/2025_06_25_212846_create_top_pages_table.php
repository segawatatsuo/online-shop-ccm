...
class CreateTopPagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('top_pages', function (Blueprint $table) {
            ...
            $table->string('hero_head_copy')->nullable()->comment('画像の上のヘッドコピー');
            $table->string('hero_lead_copy')->nullable()->comment('画像の上のコピー');

            $table->integer('section1_display_hide')->nullable()->comment('セクション1の表示・非表示 1か0かnull');
            ...
            $table->integer('section2_display_hide')->nullable()->comment('セクション2の表示・非表示 1か0かnull');
            ...
            $table->integer('section3_display_hide')->nullable()->comment('セクション3の表示・非表示 1か0かnull');
            ...
            $table->integer('section4_display_hide')->nullable()->comment('セクション4の表示・非表示 1か0かnull');
            ...
            $table->integer('movie_section_display_hide')->nullable()->comment('ムービーの表示・非表示 1か0かnull');
            $table->string('movie_section_url')->nullable()->comment('動画URL');
